...
enum ReblAmrParameters: uint
{
    ...
    WR  = 1, /*!<controls the output, set 0 to turn it off, set to 1 for polyvertex and set 2 for multiblock*/
    WEAK = 3, /*!< set to 0 for weak scaling to 1 for strong, default is 0  */
